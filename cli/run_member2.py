"""
Member 2 — Candidate Generation Orchestrator
============================================
Block purging + witness-first candidate generation -> candidate_pairs.csv
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Member 2 — Block purging + witness-first candidate generation -> candidate_pairs.csv"
    )
    parser.add_argument(
        "--dataset",
        choices=valid,
